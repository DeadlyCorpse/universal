...
-- Instances:
local GrimEx = Instance.new("ScreenGui")
...
GrimEx.Name = "GrimEx"
GrimEx.Enabled = true
GrimEx.ResetOnSpawn = true
GrimEx.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
GrimEx.DisplayOrder = 999999999
...
Logo.ZIndex = 2
Logo.Image = "http://www.roblox.com/asset/?id=115354581354163"
...
Img.Text = "^"
Img.TextColor3 = Color3.fromRGB(0, 0, 0)
Img.TextScaled = true
Img.TextSize = 14
...
local success, err = pcall(function()
	GrimEx.Parent = uiparent()
end)

if not success then
	GrimEx.Parent = game:GetService("Players").LocalPlayer.PlayerGui
end
